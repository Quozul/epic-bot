...
module.exports = {
    ...
    execute(client, msg) {
        ...
        if (!isCommand) {
            ...
            msg.guild.channels.cache.find(channel => channel.name == 'epic-logging').send(utils.getTranslation(msg, 'system.message_deleted', msg.author.id, msg.channel.id, msg.content));
